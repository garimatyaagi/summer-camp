...
const weeks = [
  ...
  { week: 4, theme: "Stories", emoji: "📖", color: "#3A8C6E",
    question: "Can you invent a story and make people feel something?",
    principle: "Imagination, structure, and communication",
    oneLiner: "They write, illustrate, and perform an original story by Friday.",
    takeHome: "Illustrated storybook + puppet",
    longTermSkills: ["Creative writing", "Storytelling structure", "Public speaking", "Empathy & perspective"],
    days: [
      { day: "Mon", activity: "Invent a character. Draw them. Give them a name, a fear, and a superpower. Build a sock puppet of them." },
      { day: "Tue", activity: "Write a 3-part story: beginning, problem, solution. Storyboard it in 6 panels like a comic." },
      { day: "Wed", activity: "Illustrate your story as a real book. Design a cover. Bind the pages together." },
      { day: "Thu", activity: "Rehearse performing your story. Use your puppet. Practice voices, timing, and eye contact." },
      { day: "Fri", activity: "Story Showcase. Perform your story to the group using your puppet and illustrated book." },
    ]},
  ...
  { week: 7, theme: "The Exhibition", emoji: "🏆", color: "#2B5797",
    ...
    oneLiner: "The final week. They pick their best work from 6 weeks, build a scrapbook, and present it all at a real exhibition on Friday.",
    ...
    days: [
      { day: "Mon", activity: "Complete your scrapbook \u2014 one illustrated page per week. Write what you learned." },
      { day: "Tue", activity: "Pick your best piece from each week. Frame your favourite. Write why you chose it." },
      { day: "Wed", activity: "Collaborate on the camp mural. Each child adds one piece that represents their summer." },
      { day: "Thu", activity: "Full dress rehearsal. Set up the gallery. Practice presenting your work. Get feedback." },
      { day: "Fri", activity: "THE EXHIBITION \u2014 gallery opening for parents. Printed labels, certificates, and a room full of proud families." },
    ]},
];
