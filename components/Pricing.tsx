...
export default function Pricing() {
  return (
    <section id="pricing" className="relative px-6 py-[80px] md:py-[120px] lg:px-12 bg-[#FDEAE5]">
      <div className="pointer-events-none">
        <DoodleStar className="absolute top-16 right-12 w-20 opacity-45 hidden md:block" color="#2B5797" />
        <DoodleHeart className="absolute bottom-20 left-10 w-16 opacity-35 hidden md:block" color="#3A8C6E" />
        <DoodleSun className="absolute top-10 left-8 w-16 opacity-35 hidden lg:block" color="#F0C75E" />
        <DoodleBrush className="absolute bottom-16 right-8 w-16 opacity-30 hidden md:block" color="#2B5797" />
        <DoodleZigzag className="absolute top-[50%] right-6 w-20 opacity-30 hidden lg:block" color="#3A8C6E" />
      </div>
